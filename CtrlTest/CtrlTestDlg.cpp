...
CCtrlTestDlg::CCtrlTestDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_CTRLTEST_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);

	pThumnailDlg = new CThumbnailDlg(this, 60, 60, true, 2, 2);
...
BEGIN_MESSAGE_MAP(CCtrlTestDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
{
	pThumnailDlg->setImageDir(_T("..\\imageSamples"), {10, 10});
